...
Section "MainSection" SEC01
  ...
  File "dist\wxmsw271h_html_vc.dll"
  File "dist\wxmsw271h_adv_vc.dll"
  File "dist\wxbase271h_vc.dll"
  File "dist\wxbase271h_net_vc.dll"
  File "dist\wxmsw271h_core_vc.dll"
  File "dist\library.zip"
  File "dist\metalink_small.ico"
  File "dist\metalink_small.png"
  File "dist\metalink.png"
...
Section Uninstall
  ...
  Delete "$INSTDIR\wxmsw271h_core_vc.dll"
  Delete "$INSTDIR\wxbase271h_net_vc.dll"
  Delete "$INSTDIR\wxbase271h_vc.dll"
  Delete "$INSTDIR\wxmsw271h_adv_vc.dll"
  Delete "$INSTDIR\wxmsw271h_html_vc.dll"
