...
for filename in filenames:
    ...
    progress = metalink.ProgressBar(55)
    results = metalink.download_metalink(filedir + filename, os.getcwd(), handler=progress.download_update)
...
##        print "FAIL: Download failed"
    ...
    elif not metalink.verify_checksum(outfile, checksums):
